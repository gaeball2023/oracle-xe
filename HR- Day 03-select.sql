 ...
 */
 ...
 /*
  열 allae 정의
     열 머리글의 이름을 바꿉니다.
     계산에서 유용합니다.
     열 이름 바로 위에 나옵니다. (열 이름과 allae 사이에 선택 사항인 AS 키워드가 올 수도 있습니다.)
...
/*
 리터럴 문자열
      리터열은 SELECT 문에 포함된 문자, 숫자 또는 날짜입니다.
      날짜 및 문자 리터럴 값은 작은 따음표로 묶어야 합니다.
...
/*
테이블 구조표시
     DECLARE  명령을 사용하여 테이블 구조를 표시합니다. 
